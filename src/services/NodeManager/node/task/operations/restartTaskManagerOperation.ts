 ...
 */
export async function restartTaskManagerOperation(this: TaskManager, group: string, opId: string): Promise<void> {
     ...
     */
    this.currentGroupOperationsPromises.set(opId, this.trackGroupOperationPromise(
        opId,
