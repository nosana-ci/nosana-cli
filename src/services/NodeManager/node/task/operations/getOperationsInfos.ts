...
export function getOperationStatus(this: TaskManager, id: string): Record<string, string | null> {
...
export function getCurrentGroupStatus(this: TaskManager): Record<string, string | null> {
...
export function getGroupStatus(this: TaskManager, group: string): Record<string, string | null> {
  const record: Record<string, string | null> = {};
